...
% TODO Conclusions:
% - calculating the distance from the root key is also not super easy
% - NS is not sent anywhere and not authenticated so potentially insecure
% - resolution is 1 day -> so only specific intermediate keys can be sent
...
A first observation we can make regarding this result is that 
