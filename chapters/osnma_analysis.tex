...
% TODO MACK offsetting
% TODO add checks on the way to the operativity of the chain and the mode of
% operation (ex. what to do at chain end)
% TODO add check for DSM-KROOT vs DSM-PKR operations
